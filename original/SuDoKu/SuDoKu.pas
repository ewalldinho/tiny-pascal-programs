(*******************************)
{
	Programa: Sudoku þaidimas.
	Funkcionalumas: sudoku ávedimas, uþkrovimas ið failo, iðsprendimas, iðsaugojimas faile.
...
Program SuDoKu_sprendejas;
   ...
   Var SDK : SuDoKu;
       ...
       // bet SuDoKU buna jau ivestas prieð tai (ivestas = TRUE)
       inputed,
       viskas : boolean;
    ...
    repeat
        ...
        case menuItem of
            ...
            1: begin
                   ...
                   if ivestas then
                   begin
                       WriteLn('Esamas SuDoKu bus uþmirðtas.');
            ...
            4: begin
                  ...
                  then begin
                      ...
                      if not Solved(SDK)
                      then begin
                          WriteLn('Nepavyko iðpræsti loginiu màstymu.');
                          WriteLn('Ar norite bandyti spëjimo bûdu?');
